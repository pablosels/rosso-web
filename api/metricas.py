...
TIPOS = {"visita", "reservar", "whatsapp", "evento", "carta", "opentable", "noches", "club", "produccion", "regalo", "spotify", "instagram", "quiz"}
...
def texto_resumen(dias=7):
    ...
    lineas = [f"📊 <b>Sitio web, últimos {dias} días</b>",
              ...
              f"Clics: OpenTable {t.get('opentable', 0)} · Instagram {t.get('instagram', 0)} · Spotify {t.get('spotify', 0)} · quiz terminados {t.get('quiz', 0)}", ""]
